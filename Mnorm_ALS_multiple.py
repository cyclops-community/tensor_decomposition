...
if __name__ == "__main__":
	...
	if args.load_tensor is not '':
		...
		[T,O] = synthetic_tensors.init_rand(tenpy,order,s,R,sp_frac,np.random.randint(100))
		...
		[T,O] = synthetic_tensors.init_collinearity_tensor(tenpy, s, order, R, args.col, np.random.randint(100))
