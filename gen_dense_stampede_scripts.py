...
for nodes in [1, 2, 4, 8, 16]:
    ...
    script_file  = open("script_dense_%s.sh" % nodes, "w")

    script_file.write("#!/bin/bash\n")
    script_file.write("#----------------------------------------------------\n")
    script_file.write("#SBATCH -J ctf_cp_lowr\n")
    script_file.write("#SBATCH -o cp_lowr.bench.dense.ppn64.N%s.o%%j.out\n" % nodes)
    script_file.write("#SBATCH -e cp_lowr.bench.dense.ppn64.N%s.o%%j.err\n" % nodes)
    ...
    script_file.write("\n")
    script_file.write("\n")
    script_file.write("for s in 1000 1500 2000\n")
    script_file.write("do\n")
    script_file.write("  for R in 500 1000 2000 4000\n")
    script_file.write("  do\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 1 6 0 1. 0 0 1 0 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 32 6 3 1. 0 0 0 1 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 128 6 3 1. 0 0 0 1 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 256 6 3 1. 0 0 0 1 0\n")
