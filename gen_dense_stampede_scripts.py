...
for nodes in [1, 2, 4, 8, 16]:
    ...
    script_file.write("  do\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 1 6 0 1. 1 1 1 0 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 32 6 3 1. 1 1 0 1 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 128 6 3 1. 1 1 0 1 0\n")
    script_file.write("    ibrun python ./als_lowr_msdt_order3.py $s $R 256 6 3 1. 1 1 0 1 0\n")
